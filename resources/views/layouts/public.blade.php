    ...
    <nav class="public-navbar">
        <div class="public-navbar-inner">
            <div class="public-brand">
                <img src="{{ asset('img/logo-sena.png') }}" alt="Logo SENA" class="sena-logo-public" style="max-width: 50px; height: auto; filter: invert(48%) sepia(85%) saturate(1483%) hue-rotate(78deg) brightness(97%) contrast(103%);">
                <div class="titles">
                    <h1>ADMIN SENA</h1>
            ...
            <div class="public-nav-links">
                ...
                <a href="{{ route('news.public.index') }}" class="{{ request()->routeIs('news.public.*') ? 'active' : '' }}">&#128240; Noticias</a>
